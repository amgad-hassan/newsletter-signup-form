...
use Drupal\newsletter_signup\SubscriptionInterface;
 ...
 * @ContentEntityType(
 *   id = "newsletter_signup_subscription",
 *   label = @Translation("Subscription entity"),
 *   handlers = {
 *     "view_builder" = "Drupal\Core\Entity\EntityViewBuilder",
 *     "list_builder" = "Drupal\newsletter_signup\SubscriptionListBuilder",
 *     "views_data" = "Drupal\views\EntityViewsData",
 *     "form" = {
 *       "add" = "Drupal\newsletter_signup\Form\SubscriptionForm",
 *       "edit" = "Drupal\newsletter_signup\Form\SubscriptionForm",
 *       "delete" = "Drupal\newsletter_signup\Form\SubscriptionDeleteForm",
 *     },
 *     "access" = "Drupal\newsletter_signup\SubscriptionAccessControlHandler",
 *   },
 ...
 *   },
 *   links = {
 *     "canonical" = "/newsletter_signup_subscription/{newsletter_signup_subscription}",
 *     "edit-form" = "/newsletter_signup_subscription/{newsletter_signup_subscription}/edit",
 *     "delete-form" = "/subscription/{newsletter_signup_subscription}/delete",
 *     "collection" = "/newsletter_signup_subscription/list"
 *   },
 *   field_ui_base_route = "newsletter_signup.subscription_settings",
 * )
 *
 ...
 * Example: 'entity.newsletter_signup_subscription.canonical'
 *
 * See routing file above for the corresponding implementation
 *
 * The 'Subscription' class defines methods and fields for the subscription entity.
 *
 * Being derived from the ContentEntityBase class, we can override the methods
 * we want. In our case we want to provide access to the standard fields about
 * creation and changed time stamps.
 *
 * Our interface (see SubscriptionInterface) also exposes the EntityOwnerInterface.
...
class Subscription extends ContentEntityBase implements SubscriptionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['langcode'] = BaseFieldDefinition::create('language')
      ...
      ->setDescription(t('The language code of Subscription entity.'));
